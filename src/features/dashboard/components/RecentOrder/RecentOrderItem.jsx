...
const RecentOrderItem = ({ order }) => {
  ...
  return (
    <>
      <div className="md:flex md:flex-row md:items-center md:justify-between flex-col  shadow-sm  border border-[var(--border)] w-full  items-center p-4 mb-4  bg-[var(--background)] rounded-3xl ">
        <div className=" ">
