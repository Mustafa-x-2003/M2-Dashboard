  ...
  return (
    <div className="bg-[var(--card)] border-[var(--border)]  rounded-2xl px-5 pt-6 relative overflow-hidden h-fit shadow-[var(--shadow)] hover:-translate-y-2 transition-all duration-300">
      ...
      <div className="flex justify-between gap-4">
        <div>
          <h2 className=" text-[var(--text-secondary)] transition-all duration-300text-sm font-bold ">
            {title}
          </h2>
          <h2 className="text-3xl transition-all duration-300 text-[var(--text)] py-2 font-bold">{data}</h2>
