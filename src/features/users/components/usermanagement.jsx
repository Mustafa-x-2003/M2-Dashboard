        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-cyan-500 hover:bg-cyan-600 active:scale-95 transition text-white px-6 py-3 rounded-2xl font-semibold shadow-md cursor-pointer"
            >
              <FaUserPlus />
              <span>Add User</span>
