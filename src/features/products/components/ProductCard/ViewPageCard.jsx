      ...
      <div className="rounded-3xl bg-gradient-to-r from-slate-950 to-slate-800 p-8 text-white">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-white/60">Product details overview</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-3xl bg-white p-6 shadow">
            <p className="text-sm uppercase text-blue-500">Overview</p>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="rounded-2xl bg-white p-5 shadow">
              ...
              <h3 className="mt-2 text-xl font-bold">{product.stock}</h3>
            </div>

            <div className="rounded-2xl bg-white p-5 shadow">
              <p className="text-xs uppercase text-gray-500">SKU</p>

              <h3 className="mt-2 text-xl font-bold">{product.sku}</h3>
            </div>
          </div>
