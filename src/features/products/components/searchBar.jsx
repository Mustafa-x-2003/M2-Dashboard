...
export default function SearchBar({
  ...
  return (
    <div className="mb-5">
      <div className="rounded-3xl border border-[var(--border)]  p-6 shadow-sm bg-[var(--card)]">
        <div className="flex  flex-col gap-3 lg:flex-row">
          {/* Search Input */}
          <div className="flex relative flex-1 items-center rounded-2xl    ">
            <span className=" absolute">
              <HiOutlineSearch className="mx-4 text-xl text-gray-400" />
            </span>
            ...
            <input
              ...
              className="flex-1 py-3 pl-10 rounded-2xl text-[var(--text)] bg-[var(--input-bg)] border border-[var(--input-border)] focus:border-[var(--input-focus)]  text-sm outline-none "
            />
          ...
          {/* Search Button */}
          <button className="flex h-12 items-center justify-center gap-2 rounded-xl bg-cyan-500 px-6 text-sm font-semibold text-white hover:bg-cyan-600 transition">
