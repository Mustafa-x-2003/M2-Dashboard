...
const StatusSection = ({ register, submitError, submitSuccess, mode }) => {
  return (
    <>
      <div className="flex flex-wrap gap-4">
        <label className="flex items-center text-[var(--text)] gap-3 rounded-2xl border border-[var(--border)] bg-[var(--card)] px-5 py-4 transition-colors duration-300 ">
