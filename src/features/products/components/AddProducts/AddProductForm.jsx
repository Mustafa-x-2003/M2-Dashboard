  ...
  const onsubmit = async (data) => {
    try {
      ...
      if (mode === "edit") {
        ...
        await createProduct(newData, newData.tags, product.images);
      }
      refresh?.();
      setshowPopup?.(false);
    } catch (error) {
    ...
    <div className={popoup ? "flex flex-col xl:flex-row" : "xl:flex mt-8"}>
      ...
      >
        ...
        <div className="  w-full py-6 flex mt-6 justify-center items-center text-center rounded-3xl border-2 border-dashed border-cyan-400/30 bg-cyan-500/5">
          <label htmlFor="imageUploader" className="  w-full  ">
            ...
            <p className="mt-3 text-xs text-gray-300 ">PNG, JPG, WEBP</p>
            <input
              id="imageUploader"
              hidden
              type="file"
        ...
        >
          ...
          <div className=" flex flex-col 2xl:grid  grid-cols-2 gap-4 ">
            ...
            <Input
              ...
              register={register}
            />
            <Input name="sku" title="SKU" type="text" register={register} />
            ...
            <Input name="brand" title="Brand" type="text" register={register} />
      ...
      ${
        ...
        ${featured ? "border-cyan-500 bg-cyan-500" : "border-slate-300"}`}
              >
                {featured && (
        ...
        active
          ...
          : "border-slate-200 bg-slate-50 text-slate-500 hover:border-slate-300"
            ...
            >
              <span
                className={`flex h-4 w-4 items-center justify-center rounded-full border-2 transition
        ${active ? "border-cyan-500 bg-cyan-500" : "border-slate-300"}`}
              >
                {active && (
                  <span className="h-1.5 w-1.5 rounded-full bg-white"></span>
                )}
