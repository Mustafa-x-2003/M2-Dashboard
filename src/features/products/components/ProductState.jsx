export default function ProductState({ logo, number, title, color }) {
  ...
  return (
    <div
      className={` border border-[var(--border)] bg-[var(--card)]  rounded-2xl p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-all duration-200`}
    >
      ...
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm font-medium capitalize mt-0.5">
          {title}
        </p>
      </div>
    </div>
