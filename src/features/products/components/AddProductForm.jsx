...
import { FiImage, FiPlus, FiX, FiAlertCircle, FiCheckCircle, FiLoader } from 'react-icons/fi';
...
export default function AddProductForm() {
  ...
  const { images, tags, isLoading, error: submitError, success: submitSuccess } = state;
  ...
  const handleImageChange = (e) => {
    ...
    dispatch({ type: 'SET_IMAGES', payload: [...images, ...files].slice(0, 5) });
            ...
            <label className="block">
              ...
              <div className="flex gap-3">
                ...
                <button
                  type="button"
                  onClick={addTag}
                  className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gray-500 text-white shadow-sm transition hover:bg-gray-400"
                >
