...
export default function AddProductsHeader() {
  ...
  return (
    <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-8 shadow-2xl">
      {/* Decorative blobs */}
      ...
      <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <div className="mt-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-xs uppercase tracking-[0.35em] text-cyan-300">Create Product</p>
              <h1 className="mt-1 text-4xl font-black text-white">Launch a polished product entry</h1>
            </div>
          </div>
        ...
        {/* Right Status Badge */}
        <div className="rounded-3xl border border-white/10 bg-white/5 p-4 text-slate-100 shadow-xl backdrop-blur shrink-0">
          <p className="text-xs uppercase tracking-[0.3em] text-cyan-300">Ready</p>
          <p className="mt-2 text-sm text-slate-200">Create, validate, and save with one click.</p>
        </div>
      </div>
    </div>
  );
