  ...
  return (
    <div className="w-full p-4 sm:p-6">
      <div className="rounded-3xl border border-[var(--border)] bg-[var(--card)] p-8 shadow-[var(--shadow)] transition-colors duration-300">
        ...
        <h1 className="mt-3 text-2xl font-semibold text-[var(--text)] transition-colors duration-300">
          Preferences and integrations
        </h1>

        <p className="mt-4 text-lg text-[var(--text-secondary)] transition-colors duration-300">
