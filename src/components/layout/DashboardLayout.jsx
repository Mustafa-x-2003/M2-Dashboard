...
export default function DashboardLayout() {
  return (
    <div className="flex min-h-screen bg-[var(--background)] transition-all duration-300">
      <aside className="fixed left-0 top-0 z-[1000] hidden h-screen w-70 border-r border-[var(--border)] bg-[var(--sidebar)] transition-all duration-300 lg:block">
      ...
      <div className="min-w-0 flex-1 lg:ml-70">
        <Navbar />
